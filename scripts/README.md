...
- `check_james_planes`: A script that can be used to check if the planes mentioned in [issue #24](https://github.com/sdr-enthusiasts/plane-alert-db/issues/24) are already in the main databases.
