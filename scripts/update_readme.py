        ...
        output.write(
            chevron.render(
                template,
                {
                    ...
                    "football_count": category_df[
                        category_df["Category"] == "Football"
                    ].shape[0],
                    "big_hello_count": category_df[
                        category_df["Category"] == "Big Hello"
                    ].shape[0],
                    "bizjets_count": category_df[
                        category_df["Category"] == "Bizjets"
                    ].shape[0],
                    "climate_crisis_count": category_df[
                        category_df["Category"] == "Climate Crisis"
                    ].shape[0],
                    "governments_count": category_df[
                        category_df["Category"] == "Governments"
                    ].shape[0],
                    "coastguard_count": category_df[
                        category_df["Category"] == "Coastguard"
                    ].shape[0],
                    "da_comrade_count": category_df[
                        category_df["Category"] == "Da Comrade"
                    ].shape[0],
                    "dictator_count": category_df[
                        category_df["Category"] == "Dictator Alert"
                    ].shape[0],
                    "distinctive_count": category_df[
                        category_df["Category"] == "Distinctive"
                    ].shape[0],
                    "dogs_jobs_count": category_df[
                        category_df["Category"] == "Dogs with Jobs"
                    ].shape[0],
                    "celeb_count": category_df[
                        category_df["Category"] == "Don't you know who I am?"
                    ].shape[0],
                    ...
                    "gunship_count": category_df[
                        category_df["Category"] == "Gunship"
                    ].shape[0],
                    "hired_gun_count": category_df[
                        category_df["Category"] == "Hired Gun"
                    ].shape[0],
                    "historic_count": category_df[
                        category_df["Category"] == "Historic"
                    ].shape[0],
                    "religious_count": category_df[
                        category_df["Category"] == "Jesus he Knows me"
                    ].shape[0],
                    "joe_cool_count": category_df[
                        category_df["Category"] == "Joe Cool"
                    ].shape[0],
                    "jump_johnny_count": category_df[
                        category_df["Category"] == "Jump Johnny Jump"
                    ].shape[0],
                    "nuclear_count": category_df[
                        category_df["Category"] == "Nuclear"
                    ].shape[0],
                    "other_air_count": category_df[
                        category_df["Category"] == "Other Air Forces"
                    ].shape[0],
                    "toy_soldiers_count": category_df[
                        category_df["Category"] == "Toy Soldiers"
                    ].shape[0],
                    "other_navies_count": category_df[
                        category_df["Category"] == "Other Navies"
                    ].shape[0],
                    "oxcart_count": category_df[
                        category_df["Category"] == "Oxcart"
                    ].shape[0],
                    ...
                    "ptolemy_count": category_df[
                        category_df["Category"] == "Ptolemy would be proud"
                    ].shape[0],
                    "quango_count": category_df[
                        category_df["Category"] == "Quango"
                    ].shape[0],
                    "oligarch_count": category_df[
                        category_df["Category"] == "Oligarch"
                    ].shape[0],
                    ...
                    "royal_navy_count": category_df[
                        category_df["Category"] == "Royal Navy Fleet Air Arm"
                    ].shape[0],
                    "aerial_firefighter_count": category_df[
                        category_df["Category"] == "Aerial Firefighter"
                    ].shape[0],
                    ...
                    "watch_fly_count": category_df[
                        category_df["Category"] == "Watch Me Fly"
                    ].shape[0],
                    "that_thing_count": category_df[
                        category_df["Category"] == "You came here in that thing?"
                    ].shape[0],
