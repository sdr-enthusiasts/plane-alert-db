...
There currently are about **14970** unique aircraft in **51** categories found in this repository. This [Dashboard](https://lookerstudio.google.com/reporting/46ff4328-09d3-4e65-ab5a-bd2ba27a18fd/page/4taCC) contains details of the main list and the most recent additions.
These aircraft are divided into four main databases:

-   [plane-alert-db.csv](plane-alert-db.csv) - A list of interesting aircraft with tags, categories and links. (14970)
-   [plane-alert-pia.csv](plane-alert-pia.csv): A list that contains PIA planes. (92)
-   [plane_images.csv](plane_images.csv): A accompanying list that contains aircraft images. (11754)
...
-   [plane-alert-mil.csv](plane-alert-mil.csv) - Military Only. (8142)
-   [plane-alert-pol.csv](plane-alert-pol.csv) - Police Forces. (924)
-   [plane-alert-gov.csv](plane-alert-gov.csv) - Governments, Gov Agencies and Dictators. (1685)
...
|Distinctive|Unique and/or special aircraft e.g. The AN-225 Myria, NASA aircraft, Testbeds|204|
...
|Other Air Forces|Air Force aircraft that are not GAF, RAF, or USAF|2027|
...
|United States Navy|United States Naval avaitors. Some say they are the best of the best.|465|
|USAF|Aircraft of the United States Air Force|2320|
