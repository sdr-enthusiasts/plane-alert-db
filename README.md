...
The list contains **6583** unique aircraft in **48** different categories.

- [plane-alert-db.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-db.csv) - The list of interesting aircraft, with tags,categories and links. (6583)
- [plane-alert-civ.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-civ.csv) - Civilian Registered Aircraft, includes Historic and Distinctive. (1048)
- [plane-alert-mil.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-mil.csv) - Military Only. (3959)
- [plane-alert-pol.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-pol.csv) - Police Forces. (858)
- [plane-alert-gov.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-gov.csv) - Governments, Gov Agencies and Dictators. (721)
- [badgers-best.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/badgers-best.csv) - My own personal selections from the main list. (2379)
...
- Dictator Alert \- People of potentially questionable morals and values (289)
...
- Must be nice \- Billionaires, not millionaires, daaaahling (20)
...
- Special Forces \- The best of the best of the best. Sir. (143)
...
- United States Navy \- United States naval avaitors. Some say they are the best of the best. (50)
- USAF \- Aircraft of the United States Air Force (2284)
- Vanity Plate \- Distinctive registrations (48)
- Watch Me Fly \- Flying and Training Schools (74)
- Who needs an Engine ? \- Gliders etc (54)
- You came here in that thing ? \- Microlights, tiny planes and helis..think Yakima Super Breezy (thanks skstrand) (31)
