...
The list contains **6138** unique aircraft in **48** different categories.

- [plane-alert-db.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-db.csv) - The list of interesting aircraft, with tags,categories and links. (6138)
- [plane-alert-civ.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-civ.csv) - Civilian Registered Aircraft, includes Historic and Distinctive. (971)
...
- Gas Bags \- Would you like to ride in my beautiful balloon ? (0)
- Governments \- Aircraft registired to Governments (43)
- Gunship \- Brrrrrrrrrrrrrrrrrrrt (256)
- Hired Gun \- Why do the dirty work when someone else can do it for you ? (57)
- Historic \- It's older than I am, and most likely has a prop. (107)
...
- Other Air Forces \- Air Force aircraft that are not RAF or USAF (204)
- Other Navies \- Navy Aircraft that are not Royal Navy Fleet Air Arm or United States Navy (23)
- Police Forces \- Your friendly neighbourhood flying (insert local colloquialism here) (749)
...
- Special Forces \- The best of the best of the best. Sir. (83)
...
- USAF \- Aircraft of the United States Air Force (2344)
- Vanity Plate \- Distinctive registrations (44)
- Watch Me Fly \- Flying and Training Schools (74)
- Who needs an Engine ? \- Gliders etc (47)
- You came here in that thing ? \- Microlights, tiny planes and helis..think Yakima Super Breezy (thanks skstrand) (26)
