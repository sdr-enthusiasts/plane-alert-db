...
The list contains **11624** unique aircraft in **48** different categories.

- [plane-alert-db.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-db.csv) - The list of interesting aircraft, with tags,categories and links. (11624)
- [plane-alert-civ.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-civ.csv) - Civilian Registered Aircraft, includes Historic and Distinctive. (2573)
- [plane-alert-mil.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-mil.csv) - Military Only. (6680)
- [plane-alert-pol.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-pol.csv) - Police Forces. (857)
- [plane-alert-gov.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-gov.csv) - Governments, Gov Agencies and Dictators. (1513)
...
- [plane-alert-db-images.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-db-images.csv) - The list of interesting aircraft, with tags,categories and links. (11624)
- [plane-alert-civ-images.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-civ-images.csv) - Civilian Registered Aircraft, includes Historic and Distinctive. (2573)
- [plane-alert-mil-images.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-mil-images.csv) - Military Only. (6680)
...
- [plane-alert-gov-images.csv](https://github.com/Sportsbadger/plane-alert-db/blob/main/plane-alert-gov-images.csv) - Governments, Gov Agencies and Dictators. (1513)
...
- As Seen on TV \- Companies and Brands (246)
...
- Da Comrade \- Russian or Soviet Aircraft. I love their design, so they get their own category (114)
- Dictator Alert \- People of potentially questionable morals and values (324)
- Distinctive \- Unique and/or special aircraft e.g The AN-225 Myria, NASA aircraft, Testbeds (164)
- Dogs with Jobs \- Aircraft with specific roles and/or modifications (104)
- Don't you know who I am ? \- Famous People. I was going to say notable, but I'll go with Famous (18)
- Flying Doctors \- Air Ambulance and Medical Flights (498)
- Football  \- Actual, Aussie Rules or American. We don't discriminate. (2)
- GAF \- Aircraft of the German Air Force, thank to Rhodan76 (363)
- Gas Bags \- Would you like to ride in my beautiful balloon ? (14)
- Governments \- Aircraft registered to Governments (230)
...
- Joe Cool \- Cool Planes. Or at least I think they are cool. (97)
...
- Other Air Forces \- Air Force aircraft that are not RAF or USAF (1808)
- Other Navies \- Navy Aircraft that are not Royal Navy Fleet Air Arm or United States Navy (166)
- Oxcart \- Intelligence gathering aircraft (438)
- PIA \- Privacy ICAO Address....you can run, but you cannot hide (4)
...
- Sock Puppet \- Someone Pretending to be something they are not e.g. Covert DOJ Aircraft (175)
- Special Forces \- The best of the best of the best. Sir. (157)
- Toy Soldiers \- Armies from around the world (502)
...
- You came here in that thing ? \- Microlights, tiny planes and helis..think Yakima Super Breezy (thanks skstrand). (93)
